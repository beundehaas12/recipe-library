        ...
        >
            ...
            <div className="mb-8">
                <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2 bg-white rounded-lg p-1 border border-zinc-100 shadow-sm">
            ...
            {showOverview ? (
                <div className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 bg-white p-8 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-zinc-100/50 min-h-[400px]">
